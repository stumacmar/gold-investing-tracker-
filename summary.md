# Gold Signal Engine — 33.2/100 TRIM

As of 2026-08-10 (generated 2026-08-10T21:13:46.090830Z).

- Gold: $4,448.60 USD / £3,293.21 GBP
...
- GBP lens: XAUGBP £3,293, -7.3% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,449: next resistance $5,306 (+19.3%, tested 2x); nearest support $3,967 (-10.8%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -0.7% vs 200DMA, RSI(14) 74 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.76 — USDJPY 159.2, +0.7% vs 200DMA; intervention-scale snap -1.9% 8 sessions ago — a 1.9% single-session yen surge off a weak base 8 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
- **L. Gold/silver ratio** (weight 2.0): +0.00 — Gold/silver ratio 68 (10th pct of 5y) — ratio mid-range; no tell either way.
...
- dfii10: 2026-08-07 (3d old) via fred-csv
- dgs10: 2026-08-07 (3d old) via fred-csv
- dgs2: 2026-08-07 (3d old) via fred-csv
- t10yie: 2026-08-10 (0d old) via fred-csv
- t5yifr: 2026-08-10 (0d old) via fred-csv
- dollar: 2026-08-07 (3d old) via fred-csv
- vix: 2026-08-07 (3d old) via fred-csv
- baa10y: 2026-08-07 (3d old) via fred-csv
- effr: 2026-08-07 (3d old) via fred-csv
