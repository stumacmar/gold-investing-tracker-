# Gold Signal Engine — 36.4/100 TRIM

As of 2026-09-17 (generated 2026-09-17T07:12:05.236462Z).

- Gold: $4,352.00 USD / £3,248.94 GBP
...
- GBP lens: XAUGBP £3,249, -2.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $109 a day (2.5% of price) — the 88th percentile of the last five years. Moves are running 1.7× normal; trim position sizes accordingly.
- Price structure: Gold $4,352: next resistance $5,315 (+22.1%, tested 2x); nearest support $3,976 (-8.6%, tested 2x). It has spent 22% of the past year between $3,988 and $4,152 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.54 — 10Y real yield 2.62%, +0.47pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.46 — Broad dollar 1.0% below its 200DMA, -1.6% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -0.92 — Price above the 50DMA, below the 200DMA (death cross in force), -4.3% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.83 — 2Y yield 4.67%, +0.60pp over 3m; 2Y 1.04pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.75 — -4.4% vs 200DMA, RSI(14) 29 — washed out — the spring is compressed.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 17, BAA-10Y spread 1.48% (-0.05pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.29 — USDJPY 155.6, -1.8% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-15 (2d old) via fred-csv
- dgs10: 2026-09-15 (2d old) via fred-csv
- dgs2: 2026-09-15 (2d old) via fred-csv
- t10yie: 2026-09-16 (1d old) via fred-csv
- t5yifr: 2026-09-16 (1d old) via fred-csv
- dollar: 2026-09-11 (6d old) via fred-csv
- vix: 2026-09-15 (2d old) via fred-csv
- baa10y: 2026-09-15 (2d old) via fred-csv
- effr: 2026-09-15 (2d old) via fred-csv
- icsa: 2026-09-05 (12d old) via fred-csv
