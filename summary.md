# Gold Signal Engine — 29.1/100 TRIM

As of 2026-08-12 (generated 2026-08-12T07:31:37.428651Z).

- Gold: $4,457.80 USD / £3,299.44 GBP
...
- GBP lens: XAUGBP £3,299, -5.1% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,458: next resistance $5,306 (+19.0%, tested 2x); nearest support $3,967 (-11.0%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): +0.44 — Price above the 50DMA, below the 200DMA (death cross in force), +10.2% over 20 sessions — the trend is doing the heavy lifting.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — -0.6% vs 200DMA, RSI(14) 83 — stretched — chasing here is paying up for someone else's exit.
...
- **N. FX stress (yen)** (weight 4.0): +0.77 — USDJPY 159.4, +0.8% vs 200DMA; intervention-scale snap -1.9% 9 sessions ago — a 1.9% single-session yen surge off a weak base 9 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
...
- dfii10: 2026-08-10 (2d old) via fred-csv
- dgs10: 2026-08-10 (2d old) via fred-csv
- dgs2: 2026-08-10 (2d old) via fred-csv
- t10yie: 2026-08-11 (1d old) via fred-csv
- t5yifr: 2026-08-11 (1d old) via fred-csv
- dollar: 2026-08-07 (5d old) via fred-csv
- vix: 2026-08-10 (2d old) via fred-csv
- baa10y: 2026-08-10 (2d old) via fred-csv
- effr: 2026-08-10 (2d old) via fred-csv
