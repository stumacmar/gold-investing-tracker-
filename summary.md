# Gold Signal Engine — 39.0/100 TRIM

As of 2026-09-14 (generated 2026-09-14T21:00:53.585791Z).

- Gold: $4,337.90 USD / £3,213.00 GBP
...
- Fair value: Reference only: the 5y fair-value regression fails its sanity check (real-yield beta +0.29 is positive — the window co-trended), so the +11% gap does not adjust the score.
- Band meaning: Macro tailwinds absent — risk posture, not a sell-timing call.
- GBP lens: XAUGBP £3,213, -4.9% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $82 a day (1.9% of price) — the 88th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,338: next resistance $5,306 (+22.3%, tested 2x); nearest support $3,967 (-8.6%, tested 2x). It has spent 22% of the past year between $3,975 and $4,143 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.48 — 10Y real yield 2.60%, +0.44pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.46 — Broad dollar 1.0% below its 200DMA, -1.6% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -0.56 — Price above the 50DMA, below the 200DMA (death cross in force), -1.0% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.79 — 2Y yield 4.63%, +0.58pp over 3m; 2Y 1.00pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.75 — -4.2% vs 200DMA, RSI(14) 30 — washed out — the spring is compressed.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 16, BAA-10Y spread 1.51% (-0.02pp 3m) — no stress signal either way.
...
- dfii10: 2026-09-11 (3d old) via fred-csv
- dgs10: 2026-09-11 (3d old) via fred-csv
- dgs2: 2026-09-11 (3d old) via fred-csv
- t10yie: 2026-09-11 (3d old) via fred-csv
- t5yifr: 2026-09-11 (3d old) via fred-csv
- dollar: 2026-09-11 (3d old) via fred-csv
- vix: 2026-09-11 (3d old) via fred-csv
- baa10y: 2026-09-10 (4d old) via fred-csv
- effr: 2026-09-11 (3d old) via fred-csv
