# Gold Signal Engine — 35.2/100 TRIM

As of 2026-09-07 (generated 2026-09-07T13:14:47.912129Z).

- Gold: $4,476.60 USD / £3,306.42 GBP
...
- Fair value: Reference only: the 5y fair-value regression fails its sanity check (real-yield beta +0.29 is positive — the window co-trended), so the +22% gap does not adjust the score.
- Band meaning: Macro tailwinds absent — risk posture, not a sell-timing call.
- GBP lens: XAUGBP £3,306, -2.4% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $80 a day (1.8% of price) — the 86th percentile of the last five years. Moves are running 1.5× normal; trim position sizes accordingly.
- Price structure: Gold $4,477: next resistance $5,306 (+18.5%, tested 2x); nearest support $3,967 (-11.4%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.19 — 10Y real yield 2.42%, +0.31pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +0.50 — Broad dollar 0.7% below its 200DMA, -0.1% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -0.14 — Price above the 50DMA, below the 200DMA (death cross in force), +2.6% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.30 — 2Y yield 4.34%, +0.29pp over 3m; 2Y 0.71pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.0% vs 200DMA, RSI(14) 57 — no stretch either way.
- **H. Fear & credit** (weight 6.0): -0.25 — VIX 14, BAA-10Y spread 1.57% (+0.03pp 3m) — markets are calm; no safe-haven bid.
...
- **N. FX stress (yen)** (weight 4.0): -0.43 — USDJPY 154.4, -2.6% vs 200DMA; no intervention footprint — no FX stress signal.
- **L. Gold/silver ratio** (weight 2.0): +0.00 — Gold/silver ratio 67 (11th pct of 5y) — ratio mid-range; no tell either way.
...
- gold_usd: 2026-09-07 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-07 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-07 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-07 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-03 (4d old) via fred-csv
- dgs10: 2026-09-03 (4d old) via fred-csv
- dgs2: 2026-09-03 (4d old) via fred-csv
- t10yie: 2026-09-04 (3d old) via fred-csv
- t5yifr: 2026-09-04 (3d old) via fred-csv
- dollar: 2026-08-28 (10d old) via fred-csv
- vix: 2026-09-03 (4d old) via fred-csv
- baa10y: 2026-09-03 (4d old) via fred-csv
- effr: 2026-09-03 (4d old) via fred-csv
- icsa: 2026-08-29 (9d old) via fred-csv
- unrate: 2026-08-01 (37d old) via fred-csv
- payems: 2026-08-01 (37d old) via fred-csv
- cot: 2026-09-01 (6d old) via cftc-socrata
- gpr: 2026-08-01 (37d old) via iacoviello-xls
- central_banks: 2026-07-30 (39d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (39d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
