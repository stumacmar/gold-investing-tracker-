# Gold Signal Engine — 31.3/100 TRIM

As of 2026-08-11 (generated 2026-08-11T21:14:21.651306Z).

- Gold: $4,427.80 USD / £3,278.87 GBP
...
- GBP lens: XAUGBP £3,279, -5.7% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,428: next resistance $5,306 (+19.8%, tested 2x); nearest support $3,967 (-10.4%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.61 — 10Y real yield 2.43%, +0.50pp over 3m — rising real yields are gold’s biggest headwind.
- **E. Trend & momentum** (weight 12.0): +0.40 — Price above the 50DMA, below the 200DMA (death cross in force), +9.0% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.40 — 2Y yield 4.25%, +0.35pp over 3m; 2Y 0.62pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **B. Dollar** (weight 9.0): -0.07 — Broad dollar 0.6% below its 200DMA, +0.9% over 3m — a firm dollar caps gold.
- **D. Inflation expectations** (weight 8.0): -1.20 — 10Y breakevens 2.27% (-0.20pp 3m), 5y5y 2.31% (+0.04pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.2% vs 200DMA, RSI(14) 70 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.76 — USDJPY 159.3, +0.7% vs 200DMA; intervention-scale snap -1.9% 9 sessions ago — a 1.9% single-session yen surge off a weak base 9 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
...
- dfii10: 2026-08-10 (1d old) via fred-csv
- dgs10: 2026-08-10 (1d old) via fred-csv
- dgs2: 2026-08-10 (1d old) via fred-csv
- t10yie: 2026-08-11 (0d old) via fred-csv
- t5yifr: 2026-08-11 (0d old) via fred-csv
- dollar: 2026-08-07 (4d old) via fred-csv
- vix: 2026-08-10 (1d old) via fred-csv
- baa10y: 2026-08-10 (1d old) via fred-csv
- effr: 2026-08-10 (1d old) via fred-csv
