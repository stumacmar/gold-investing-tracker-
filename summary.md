...
As of 2026-08-10 (generated 2026-08-10T07:33:02.466211Z).

- Gold: $4,414.30 USD / £3,271.44 GBP
...
- GBP lens: XAUGBP £3,271, -7.9% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,414: next resistance $5,306 (+20.2%, tested 2x); nearest support $3,967 (-10.1%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): +0.40 — Price above the 50DMA, below the 200DMA (death cross in force), +10.4% over 20 sessions — the trend is doing the heavy lifting.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.5% vs 200DMA, RSI(14) 72 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.68 — USDJPY 158.5, +0.3% vs 200DMA; intervention-scale snap -1.9% 7 sessions ago — a 1.9% single-session yen surge off a weak base 7 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
