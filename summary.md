# Gold Signal Engine — 32.5/100 TRIM

As of 2026-09-17 (generated 2026-09-17T21:01:01.268864Z).

- Gold: $4,380.60 USD / £3,279.27 GBP
...
- GBP lens: XAUGBP £3,279, -2.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $112 a day (2.6% of price) — the 90th percentile of the last five years. Moves are running 1.7× normal; trim position sizes accordingly.
- Price structure: Gold $4,381: next resistance $5,315 (+21.3%, tested 2x); nearest support $3,976 (-9.2%, tested 2x). It has spent 22% of the past year between $3,988 and $4,152 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.85 — Price above the 50DMA, below the 200DMA (death cross in force), -3.6% over 20 sessions — the tape is against you.
...
- **D. Inflation expectations** (weight 8.0): +0.24 — 10Y breakevens 2.33% (+0.04pp 3m), 5y5y 2.31% (+0.09pp) — inflation expectations drifting higher.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -3.8% vs 200DMA, RSI(14) 30 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 18, BAA-10Y spread 1.48% (-0.05pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.26 — USDJPY 155.9, -1.6% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-09-17 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-17 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-17 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-17 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-16 (1d old) via fred-csv
- dgs10: 2026-09-16 (1d old) via fred-csv
- dgs2: 2026-09-16 (1d old) via fred-csv
- t10yie: 2026-09-16 (1d old) via fred-csv
- t5yifr: 2026-09-16 (1d old) via fred-csv
- dollar: 2026-09-11 (6d old) via fred-csv
- vix: 2026-09-16 (1d old) via fred-csv
- baa10y: 2026-09-15 (2d old) via fred-csv
- effr: 2026-09-16 (1d old) via fred-csv
- icsa: 2026-09-12 (5d old) via fred-csv
- unrate: 2026-08-01 (47d old) via fred-csv
- payems: 2026-08-01 (47d old) via fred-csv
- cot: 2026-09-08 (9d old) via cftc-socrata
- gpr: 2026-08-01 (47d old) via iacoviello-xls
- central_banks: 2026-07-30 (49d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (49d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
