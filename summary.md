# Gold Signal Engine — 34.8/100 TRIM

As of 2026-09-08 (generated 2026-09-08T07:09:43.299162Z).

- Gold: $4,448.60 USD / £3,285.42 GBP
...
- GBP lens: XAUGBP £3,285, -3.1% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,449: next resistance $5,306 (+19.3%, tested 2x); nearest support $3,967 (-10.8%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.21 — Price above the 50DMA, below the 200DMA (death cross in force), +2.0% over 20 sessions — the tape is against you.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.6% vs 200DMA, RSI(14) 55 — no stretch either way.
...
- dfii10: 2026-09-03 (5d old) via fred-csv
- dgs10: 2026-09-03 (5d old) via fred-csv
- dgs2: 2026-09-03 (5d old) via fred-csv
- t10yie: 2026-09-04 (4d old) via fred-csv
- t5yifr: 2026-09-04 (4d old) via fred-csv
- dollar: 2026-08-28 (11d old) via fred-csv
- vix: 2026-09-03 (5d old) via fred-csv
- baa10y: 2026-09-03 (5d old) via fred-csv
- effr: 2026-09-03 (5d old) via fred-csv
