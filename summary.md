# Gold Signal Engine — 45.0/100 TRIM

As of 2026-08-24 (generated 2026-08-24T07:54:54.709193Z).

- Gold: $4,692.10 USD / £3,441.09 GBP
...
- GBP lens: XAUGBP £3,441, +3.0% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $84 a day (1.8% of price) — the 86th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,692: next resistance $5,306 (+13.1%, tested 2x); nearest support $3,967 (-15.5%, tested 2x). It has spent 23% of the past year between $3,960 and $4,155 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 23.0): -0.99 — 10Y real yield 2.35%, +0.22pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 17.25): +0.34 — Broad dollar 0.7% below its 200DMA, +0.2% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): +1.95 — Price above the 50DMA, above the 200DMA (death cross in force), +15.2% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.00 — 2Y yield 4.19%, +0.15pp over 3m; 2Y 0.56pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): -0.30 — 10Y breakevens 2.34% (-0.05pp 3m), 5y5y 2.34% (+0.13pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): -1.25 — +4.2% vs 200DMA, RSI(14) 87 — stretched — chasing here is paying up for someone else's exit.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 16, BAA-10Y spread 1.64% (+0.05pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.09 — USDJPY 159.1, +0.5% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-08-24 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-24 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-24 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-24 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-20 (4d old) via fred-csv
- dgs10: 2026-08-20 (4d old) via fred-csv
- dgs2: 2026-08-20 (4d old) via fred-csv
- t10yie: 2026-08-21 (3d old) via fred-csv
- t5yifr: 2026-08-21 (3d old) via fred-csv
- dollar: 2026-08-14 (10d old) via fred-csv
- vix: 2026-08-20 (4d old) via fred-csv
- baa10y: 2026-08-20 (4d old) via fred-csv
- effr: 2026-08-20 (4d old) via fred-csv
- icsa: 2026-08-15 (9d old) via fred-csv
- unrate: 2026-07-01 (54d old) via fred-csv
- payems: 2026-07-01 (54d old) via fred-csv
- cot: 2026-08-18 (6d old) via cftc-socrata
- gpr: 2026-07-01 (54d old) via iacoviello-xls
- central_banks: 2026-07-30 (25d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (25d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
