# Gold Signal Engine — 43.1/100 TRIM

As of 2026-09-11 (generated 2026-09-11T07:09:38.415806Z).

- Gold: $4,394.20 USD / £3,250.21 GBP
...
- GBP lens: XAUGBP £3,250, -3.6% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $75 a day (1.7% of price) — the 83rd percentile of the last five years. Moves are running 1.5× normal; trim position sizes accordingly.
- Price structure: Gold $4,394: next resistance $5,306 (+20.8%, tested 2x); nearest support $3,967 (-9.7%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.08 — 10Y real yield 2.46%, +0.26pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.62 — Broad dollar 1.2% below its 200DMA, -1.7% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -0.38 — Price above the 50DMA, below the 200DMA (death cross in force), +0.7% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.31 — 2Y yield 4.43%, +0.30pp over 3m; 2Y 0.80pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): +0.36 — 10Y breakevens 2.40% (+0.06pp 3m), 5y5y 2.34% (+0.10pp) — inflation expectations drifting higher.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -2.9% vs 200DMA, RSI(14) 33 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 16, BAA-10Y spread 1.55% (+0.02pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.44 — USDJPY 154.2, -2.7% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-09-11 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-11 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-11 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-11 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-09 (2d old) via fred-csv
- dgs10: 2026-09-09 (2d old) via fred-csv
- dgs2: 2026-09-09 (2d old) via fred-csv
- t10yie: 2026-09-10 (1d old) via fred-csv
- t5yifr: 2026-09-10 (1d old) via fred-csv
- dollar: 2026-09-04 (7d old) via fred-csv
- vix: 2026-09-09 (2d old) via fred-csv
- baa10y: 2026-09-09 (2d old) via fred-csv
- effr: 2026-09-09 (2d old) via fred-csv
- icsa: 2026-09-05 (6d old) via fred-csv
- unrate: 2026-08-01 (41d old) via fred-csv
- payems: 2026-08-01 (41d old) via fred-csv
- cot: 2026-09-01 (10d old) via cftc-socrata
- gpr: 2026-08-01 (41d old) via iacoviello-xls
- central_banks: 2026-07-30 (43d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (43d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
