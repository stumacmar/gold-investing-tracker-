# Gold Signal Engine — 34.9/100 TRIM

As of 2026-09-07 (generated 2026-09-07T23:04:41.788581Z).

- Gold: $4,452.80 USD / £3,287.59 GBP
...
- GBP lens: XAUGBP £3,288, -3.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $80 a day (1.8% of price) — the 86th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,453: next resistance $5,306 (+19.2%, tested 2x); nearest support $3,967 (-10.9%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.20 — Price above the 50DMA, below the 200DMA (death cross in force), +2.1% over 20 sessions — the tape is against you.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.5% vs 200DMA, RSI(14) 55 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.45 — USDJPY 154.1, -2.7% vs 200DMA; no intervention footprint — no FX stress signal.
