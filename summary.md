# Gold Signal Engine — 33.0/100 TRIM

As of 2026-08-11 (generated 2026-08-11T07:28:09.324452Z).

- Gold: $4,420.00 USD / £3,273.72 GBP
...
- GBP lens: XAUGBP £3,274, -7.8% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $81 a day (1.8% of price) — the 87th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,420: next resistance $5,306 (+20.1%, tested 2x); nearest support $3,967 (-10.3%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.48 — 10Y real yield 2.40%, +0.44pp over 3m — rising real yields are gold’s biggest headwind.
- **E. Trend & momentum** (weight 12.0): +0.39 — Price above the 50DMA, below the 200DMA (death cross in force), +8.8% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.21 — 2Y yield 4.19%, +0.27pp over 3m; 2Y 0.56pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **B. Dollar** (weight 9.0): -0.07 — Broad dollar 0.6% below its 200DMA, +0.9% over 3m — a firm dollar caps gold.
- **D. Inflation expectations** (weight 8.0): -0.96 — 10Y breakevens 2.29% (-0.16pp 3m), 5y5y 2.33% (+0.05pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.4% vs 200DMA, RSI(14) 70 — no stretch either way.
- **H. Fear & credit** (weight 7.8): -0.25 — VIX 15, BAA-10Y spread 1.64% (-0.01pp 3m) — markets are calm; no safe-haven bid.
...
- **N. FX stress (yen)** (weight 4.0): +0.76 — USDJPY 159.3, +0.7% vs 200DMA; intervention-scale snap -1.9% 8 sessions ago — a 1.9% single-session yen surge off a weak base 8 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
...
- gold_usd: 2026-08-11 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-11 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-11 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-11 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-07 (4d old) via fred-csv
- dgs10: 2026-08-07 (4d old) via fred-csv
- dgs2: 2026-08-07 (4d old) via fred-csv
- t10yie: 2026-08-10 (1d old) via fred-csv
- t5yifr: 2026-08-10 (1d old) via fred-csv
- dollar: 2026-08-07 (4d old) via fred-csv
- vix: 2026-08-07 (4d old) via fred-csv
- baa10y: 2026-08-07 (4d old) via fred-csv
- effr: 2026-08-07 (4d old) via fred-csv
- icsa: 2026-08-01 (10d old) via fred-csv
- unrate: 2026-07-01 (41d old) via fred-csv
- payems: 2026-07-01 (41d old) via fred-csv
- cot: 2026-08-04 (7d old) via cftc-socrata
- gpr: 2026-07-01 (41d old) via iacoviello-xls
- central_banks: 2026-07-30 (12d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (12d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
