# Gold Signal Engine — 51.0/100 HOLD

As of 2026-08-24 (generated 2026-08-24T21:16:33.176695Z).

- Gold: $4,710.00 USD / £3,455.02 GBP
...
- GBP lens: XAUGBP £3,455, +3.4% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $85 a day (1.8% of price) — the 86th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,710: next resistance $5,306 (+12.7%, tested 2x); nearest support $3,967 (-15.8%, tested 2x). It has spent 23% of the past year between $3,960 and $4,155 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -0.99 — 10Y real yield 2.40%, +0.22pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.42 — Broad dollar 1.3% below its 200DMA, -1.1% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): +1.96 — Price above the 50DMA, above the 200DMA (death cross in force), +15.6% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.07 — 2Y yield 4.24%, +0.16pp over 3m; 2Y 0.61pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): -0.48 — 10Y breakevens 2.32% (-0.08pp 3m), 5y5y 2.32% (+0.06pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): -1.25 — +4.6% vs 200DMA, RSI(14) 88 — stretched — chasing here is paying up for someone else's exit.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 15, BAA-10Y spread 1.63% (+0.04pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.07 — USDJPY 159.0, +0.4% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-08-21 (3d old) via fred-csv
- dgs10: 2026-08-21 (3d old) via fred-csv
- dgs2: 2026-08-21 (3d old) via fred-csv
- t10yie: 2026-08-24 (0d old) via fred-csv
- t5yifr: 2026-08-24 (0d old) via fred-csv
- dollar: 2026-08-21 (3d old) via fred-csv
- vix: 2026-08-21 (3d old) via fred-csv
- baa10y: 2026-08-21 (3d old) via fred-csv
- effr: 2026-08-21 (3d old) via fred-csv
