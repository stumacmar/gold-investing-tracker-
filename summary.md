# Gold Signal Engine — 43.8/100 TRIM

As of 2026-09-08 (generated 2026-09-08T21:00:53.544232Z).

- Gold: $4,395.60 USD / £3,247.51 GBP
...
- GBP lens: XAUGBP £3,248, -4.2% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $84 a day (1.9% of price) — the 89th percentile of the last five years. Moves are running 1.7× normal; trim position sizes accordingly.
- Price structure: Gold $4,396: next resistance $5,306 (+20.7%, tested 2x); nearest support $3,967 (-9.8%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.35 — Price above the 50DMA, below the 200DMA (death cross in force), +0.8% over 20 sessions — the tape is against you.
...
- **D. Inflation expectations** (weight 8.0): -0.06 — 10Y breakevens 2.35% (-0.01pp 3m), 5y5y 2.33% (+0.09pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -2.8% vs 200DMA, RSI(14) 52 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.48 — USDJPY 153.9, -2.9% vs 200DMA; no intervention footprint — no FX stress signal.
...
- **D**: 10Y breakeven above 2.36% flips inflation expectations bullish.

## Data freshness

- gold_usd: 2026-09-08 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-08 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-08 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-08 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-04 (4d old) via fred-csv
- dgs10: 2026-09-04 (4d old) via fred-csv
- dgs2: 2026-09-04 (4d old) via fred-csv
- t10yie: 2026-09-04 (4d old) via fred-csv
- t5yifr: 2026-09-04 (4d old) via fred-csv
- dollar: 2026-09-04 (4d old) via fred-csv
- vix: 2026-09-07 (1d old) via fred-csv
- baa10y: 2026-09-03 (5d old) via fred-csv
- effr: 2026-09-04 (4d old) via fred-csv
- icsa: 2026-08-29 (10d old) via fred-csv
- unrate: 2026-08-01 (38d old) via fred-csv
- payems: 2026-08-01 (38d old) via fred-csv
- cot: 2026-09-01 (7d old) via cftc-socrata
- gpr: 2026-08-01 (38d old) via iacoviello-xls
- central_banks: 2026-07-30 (40d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (40d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
