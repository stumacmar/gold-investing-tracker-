...
As of 2026-08-25 (generated 2026-08-25T21:14:48.995549Z).

- Gold: $4,715.90 USD / £3,455.06 GBP
...
- GBP lens: XAUGBP £3,455, +2.9% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $83 a day (1.8% of price) — the 85th percentile of the last five years. Moves are running 1.5× normal; trim position sizes accordingly.
- Price structure: Gold $4,716: next resistance $5,306 (+12.5%, tested 2x); nearest support $3,967 (-15.9%, tested 2x). It has spent 23% of the past year between $3,960 and $4,155 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): +1.94 — Price above the 50DMA, above the 200DMA (death cross in force), +16.8% over 20 sessions — the trend is doing the heavy lifting.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — +4.7% vs 200DMA, RSI(14) 85 — stretched — chasing here is paying up for someone else's exit.
...
- **N. FX stress (yen)** (weight 4.0): +0.09 — USDJPY 159.2, +0.5% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-08-25 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-25 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-25 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-25 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-24 (1d old) via fred-csv
- dgs10: 2026-08-24 (1d old) via fred-csv
- dgs2: 2026-08-24 (1d old) via fred-csv
- t10yie: 2026-08-25 (0d old) via fred-csv
- t5yifr: 2026-08-25 (0d old) via fred-csv
- dollar: 2026-08-21 (4d old) via fred-csv
- vix: 2026-08-24 (1d old) via fred-csv
- baa10y: 2026-08-24 (1d old) via fred-csv
- effr: 2026-08-24 (1d old) via fred-csv
- icsa: 2026-08-15 (10d old) via fred-csv
- unrate: 2026-07-01 (55d old) via fred-csv
- payems: 2026-07-01 (55d old) via fred-csv
- cot: 2026-08-18 (7d old) via cftc-socrata
- gpr: 2026-07-01 (55d old) via iacoviello-xls
- central_banks: 2026-07-30 (26d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (26d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
