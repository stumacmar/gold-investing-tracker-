# Gold Signal Engine — 47.1/100 HOLD

As of 2026-08-28 (generated 2026-08-28T19:13:05.899133Z).

- Gold: $4,508.20 USD / £3,331.11 GBP
...
- GBP lens: XAUGBP £3,331, -3.9% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,508: next resistance $5,306 (+17.7%, tested 2x); nearest support $3,967 (-12.0%, tested 2x). It has spent 23% of the past year between $3,967 and $4,155 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.06 — 10Y real yield 2.34%, +0.25pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.42 — Broad dollar 1.3% below its 200DMA, -1.1% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): +0.42 — Price above the 50DMA, below the 200DMA (death cross in force), +11.3% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.07 — 2Y yield 4.19%, +0.19pp over 3m; 2Y 0.56pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): -0.36 — 10Y breakevens 2.33% (-0.06pp 3m), 5y5y 2.35% (+0.11pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -0.1% vs 200DMA, RSI(14) 62 — no stretch either way.
- **H. Fear & credit** (weight 6.0): -0.25 — VIX 15, BAA-10Y spread 1.61% (+0.04pp 3m) — markets are calm; no safe-haven bid.
...
- **N. FX stress (yen)** (weight 4.0): +0.18 — USDJPY 160.1, +1.1% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-08-28 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-28 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-28 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-28 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-26 (2d old) via fred-csv
- dgs10: 2026-08-26 (2d old) via fred-csv
- dgs2: 2026-08-26 (2d old) via fred-csv
- t10yie: 2026-08-27 (1d old) via fred-csv
- t5yifr: 2026-08-27 (1d old) via fred-csv
- dollar: 2026-08-21 (7d old) via fred-csv
- vix: 2026-08-27 (1d old) via fred-csv
- baa10y: 2026-08-26 (2d old) via fred-csv
- effr: 2026-08-27 (1d old) via fred-csv
- icsa: 2026-08-22 (6d old) via fred-csv
- unrate: 2026-07-01 (58d old) via fred-csv
- payems: 2026-07-01 (58d old) via fred-csv
- cot: 2026-08-18 (10d old) via cftc-socrata
- gpr: 2026-07-01 (58d old) via iacoviello-xls
- central_banks: 2026-07-30 (29d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (29d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
