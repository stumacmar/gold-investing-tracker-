# Gold Signal Engine — 46.2/100 TRIM

As of 2026-09-10 (generated 2026-09-10T07:09:30.550275Z).

- Gold: $4,467.30 USD / £3,296.33 GBP
...
- GBP lens: XAUGBP £3,296, -2.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $75 a day (1.7% of price) — the 82nd percentile of the last five years. Moves are running 1.4× normal; trim position sizes accordingly.
- Price structure: Gold $4,467: next resistance $5,306 (+18.8%, tested 2x); nearest support $3,967 (-11.2%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.28 — Price above the 50DMA, below the 200DMA (death cross in force), +1.3% over 20 sessions — the tape is against you.
...
- **D. Inflation expectations** (weight 8.0): +0.24 — 10Y breakevens 2.37% (+0.04pp 3m), 5y5y 2.33% (+0.11pp) — inflation expectations drifting higher.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -1.3% vs 200DMA, RSI(14) 47 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.50 — VIX 16, BAA-10Y spread 1.57% (+0.05pp 3m) — fear is bidding for havens.
...
- **N. FX stress (yen)** (weight 4.0): -0.52 — USDJPY 153.5, -3.1% vs 200DMA; no intervention footprint — yen strong versus trend — no FX stress channel supporting gold.
...
- gold_usd: 2026-09-10 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-10 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-10 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-10 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-08 (2d old) via fred-csv
- dgs10: 2026-09-08 (2d old) via fred-csv
- dgs2: 2026-09-08 (2d old) via fred-csv
- t10yie: 2026-09-09 (1d old) via fred-csv
- t5yifr: 2026-09-09 (1d old) via fred-csv
- dollar: 2026-09-04 (6d old) via fred-csv
- vix: 2026-09-08 (2d old) via fred-csv
- baa10y: 2026-09-08 (2d old) via fred-csv
- effr: 2026-09-08 (2d old) via fred-csv
- icsa: 2026-08-29 (12d old) via fred-csv
- unrate: 2026-08-01 (40d old) via fred-csv
- payems: 2026-08-01 (40d old) via fred-csv
- cot: 2026-09-01 (9d old) via cftc-socrata
- gpr: 2026-08-01 (40d old) via iacoviello-xls
- central_banks: 2026-07-30 (42d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (42d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
