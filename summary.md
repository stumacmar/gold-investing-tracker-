# Gold Signal Engine — 19.5/100 SELL/REDUCE

As of 2026-09-25 (generated 2026-09-25T21:00:45.178978Z).

- Gold: $4,321.10 USD / £3,262.09 GBP
...
- GBP lens: XAUGBP £3,262, -0.3% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,321: next resistance $5,315 (+23.0%, tested 2x); nearest support $3,976 (-8.0%, tested 2x). It has spent 21% of the past year between $3,987 and $4,142 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.97 — 10Y real yield 2.85%, +0.66pp over 3m — rising real yields are gold’s biggest headwind.
...
- **C. Policy trajectory** (weight 10.0): -2.00 — 2Y yield 4.87%, +0.78pp over 3m; 2Y 0.99pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -5.2% vs 200DMA, RSI(14) 32 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.13 — USDJPY 157.2, -0.8% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-24 (1d old) via fred-csv
- dgs10: 2026-09-24 (1d old) via fred-csv
- dgs2: 2026-09-24 (1d old) via fred-csv
