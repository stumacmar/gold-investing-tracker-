# Gold Signal Engine — 42.9/100 TRIM

As of 2026-09-14 (generated 2026-09-14T07:19:05.124848Z).

- Gold: $4,360.90 USD / £3,230.51 GBP
...
- GBP lens: XAUGBP £3,231, -4.4% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $70 a day (1.6% of price) — the 81st percentile of the last five years. Moves are running 1.4× normal; trim position sizes accordingly.
- Price structure: Gold $4,361: next resistance $5,306 (+21.7%, tested 2x); nearest support $3,967 (-9.0%, tested 2x). It has spent 22% of the past year between $3,975 and $4,143 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.50 — Price above the 50DMA, below the 200DMA (death cross in force), -0.4% over 20 sessions — the tape is against you.
...
- **D. Inflation expectations** (weight 8.0): +0.42 — 10Y breakevens 2.36% (+0.07pp 3m), 5y5y 2.32% (+0.14pp) — inflation expectations drifting higher.
...
- **G. Valuation stretch** (weight 8.0): +0.75 — -3.7% vs 200DMA, RSI(14) 28 — washed out — the spring is compressed.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 18, BAA-10Y spread 1.51% (-0.02pp 3m) — no stress signal either way.
...
- gold_usd: 2026-09-14 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-14 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-14 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-14 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-10 (4d old) via fred-csv
- dgs10: 2026-09-10 (4d old) via fred-csv
- dgs2: 2026-09-10 (4d old) via fred-csv
- t10yie: 2026-09-11 (3d old) via fred-csv
- t5yifr: 2026-09-11 (3d old) via fred-csv
- dollar: 2026-09-04 (10d old) via fred-csv
- vix: 2026-09-10 (4d old) via fred-csv
- baa10y: 2026-09-10 (4d old) via fred-csv
- effr: 2026-09-10 (4d old) via fred-csv
- icsa: 2026-09-05 (9d old) via fred-csv
- unrate: 2026-08-01 (44d old) via fred-csv
- payems: 2026-08-01 (44d old) via fred-csv
- cot: 2026-09-08 (6d old) via cftc-socrata
- gpr: 2026-08-01 (44d old) via iacoviello-xls
- central_banks: 2026-07-30 (46d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (46d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
