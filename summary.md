# Gold Signal Engine — 32.9/100 TRIM

As of 2026-09-16 (generated 2026-09-16T21:00:48.652458Z).

- Gold: $4,302.50 USD / £3,215.39 GBP
...
- GBP lens: XAUGBP £3,215, -3.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $111 a day (2.6% of price) — the 90th percentile of the last five years. Moves are running 1.7× normal; trim position sizes accordingly.
- Price structure: Gold $4,302: next resistance $5,315 (+23.5%, tested 2x); nearest support $3,976 (-7.6%, tested 2x). It has spent 22% of the past year between $3,988 and $4,152 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -1.78 — Price below the 50DMA, below the 200DMA (death cross in force), -2.7% over 20 sessions — the tape is against you.
...
- **N. FX stress (yen)** (weight 4.0): -0.23 — USDJPY 156.2, -1.4% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-15 (1d old) via fred-csv
- dgs10: 2026-09-15 (1d old) via fred-csv
- dgs2: 2026-09-15 (1d old) via fred-csv
- t10yie: 2026-09-15 (1d old) via fred-csv
- t5yifr: 2026-09-15 (1d old) via fred-csv
- dollar: 2026-09-11 (5d old) via fred-csv
- vix: 2026-09-15 (1d old) via fred-csv
- baa10y: 2026-09-14 (2d old) via fred-csv
- effr: 2026-09-15 (1d old) via fred-csv
