# Gold Signal Engine — 43.0/100 TRIM

As of 2026-09-10 (generated 2026-09-10T21:01:03.624107Z).

- Gold: $4,356.40 USD / £3,222.30 GBP
...
- GBP lens: XAUGBP £3,222, -4.5% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $79 a day (1.8% of price) — the 86th percentile of the last five years. Moves are running 1.6× normal; trim position sizes accordingly.
- Price structure: Gold $4,356: next resistance $5,306 (+21.8%, tested 2x); nearest support $3,967 (-8.9%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): -0.58 — Price above the 50DMA, below the 200DMA (death cross in force), -1.2% over 20 sessions — the tape is against you.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -3.7% vs 200DMA, RSI(14) 40 — no stretch either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.43 — USDJPY 154.3, -2.6% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-09 (1d old) via fred-csv
- dgs10: 2026-09-09 (1d old) via fred-csv
- dgs2: 2026-09-09 (1d old) via fred-csv
- t10yie: 2026-09-09 (1d old) via fred-csv
- t5yifr: 2026-09-09 (1d old) via fred-csv
- dollar: 2026-09-04 (6d old) via fred-csv
- vix: 2026-09-09 (1d old) via fred-csv
- baa10y: 2026-09-08 (2d old) via fred-csv
- effr: 2026-09-09 (1d old) via fred-csv
- icsa: 2026-09-05 (5d old) via fred-csv
