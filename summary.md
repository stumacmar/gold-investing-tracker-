# Gold Signal Engine — 52.5/100 HOLD

As of 2026-08-25 (generated 2026-08-25T07:40:50.347438Z).

- Gold: $4,695.60 USD / £3,442.72 GBP
...
- GBP lens: XAUGBP £3,443, +3.1% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
...
- Price structure: Gold $4,696: next resistance $5,306 (+13.0%, tested 2x); nearest support $3,967 (-15.5%, tested 2x). It has spent 23% of the past year between $3,960 and $4,155 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): +1.93 — Price above the 50DMA, above the 200DMA (death cross in force), +16.3% over 20 sessions — the trend is doing the heavy lifting.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — +4.2% vs 200DMA, RSI(14) 85 — stretched — chasing here is paying up for someone else's exit.
...
- dfii10: 2026-08-21 (4d old) via fred-csv
- dgs10: 2026-08-21 (4d old) via fred-csv
- dgs2: 2026-08-21 (4d old) via fred-csv
- t10yie: 2026-08-24 (1d old) via fred-csv
- t5yifr: 2026-08-24 (1d old) via fred-csv
- dollar: 2026-08-21 (4d old) via fred-csv
- vix: 2026-08-21 (4d old) via fred-csv
- baa10y: 2026-08-21 (4d old) via fred-csv
- effr: 2026-08-21 (4d old) via fred-csv
