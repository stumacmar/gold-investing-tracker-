# Gold Signal Engine — 29.2/100 TRIM

As of 2026-08-13 (generated 2026-08-13T21:14:30.166402Z).

- Gold: $4,407.10 USD / £3,268.35 GBP
...
- GBP lens: XAUGBP £3,268, -6.5% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,407: next resistance $5,306 (+20.4%, tested 2x); nearest support $3,967 (-10.0%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 23.0): -1.46 — 10Y real yield 2.42%, +0.43pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 17.25): -0.07 — Broad dollar 0.6% below its 200DMA, +0.9% over 3m — a firm dollar caps gold.
- **E. Trend & momentum** (weight 12.0): +0.43 — Price above the 50DMA, below the 200DMA (death cross in force), +10.6% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.10 — 2Y yield 4.20%, +0.20pp over 3m; 2Y 0.57pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): -1.38 — 10Y breakevens 2.24% (-0.23pp 3m), 5y5y 2.27% (+0.03pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — -1.7% vs 200DMA, RSI(14) 80 — stretched — chasing here is paying up for someone else's exit.
- **H. Fear & credit** (weight 6.0): -0.25 — VIX 15, BAA-10Y spread 1.66% (+0.00pp 3m) — markets are calm; no safe-haven bid.
...
- **N. FX stress (yen)** (weight 4.0): +0.14 — USDJPY 159.5, +0.8% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-08-12 (1d old) via fred-csv
- dgs10: 2026-08-12 (1d old) via fred-csv
- dgs2: 2026-08-12 (1d old) via fred-csv
- t10yie: 2026-08-13 (0d old) via fred-csv
- t5yifr: 2026-08-13 (0d old) via fred-csv
- dollar: 2026-08-07 (6d old) via fred-csv
- vix: 2026-08-12 (1d old) via fred-csv
- baa10y: 2026-08-12 (1d old) via fred-csv
- effr: 2026-08-12 (1d old) via fred-csv
- icsa: 2026-08-08 (5d old) via fred-csv
