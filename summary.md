# Gold Signal Engine — 25.1/100 TRIM

As of 2026-09-24 (generated 2026-09-24T21:01:12.921243Z).

- Gold: $4,307.10 USD / £3,259.66 GBP
...
- GBP lens: XAUGBP £3,260, -2.8% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $101 a day (2.3% of price) — the 84th percentile of the last five years. Moves are running 1.5× normal; trim position sizes accordingly.
- Price structure: Gold $4,307: next resistance $5,315 (+23.4%, tested 2x); nearest support $3,976 (-7.7%, tested 2x). It has spent 21% of the past year between $3,991 and $4,146 — price is above it.
...
- **G. Valuation stretch** (weight 8.0): +0.75 — -5.5% vs 200DMA, RSI(14) 25 — washed out — the spring is compressed.
...
- **N. FX stress (yen)** (weight 4.0): +0.04 — USDJPY 158.8, +0.2% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-23 (1d old) via fred-csv
- dgs10: 2026-09-23 (1d old) via fred-csv
- dgs2: 2026-09-23 (1d old) via fred-csv
...
- effr: 2026-09-23 (1d old) via fred-csv
- icsa: 2026-09-19 (5d old) via fred-csv
