...
As of 2026-08-26 (generated 2026-08-26T07:42:11.750990Z).

- Gold: $4,689.30 USD / £3,438.90 GBP
...
- GBP lens: XAUGBP £3,439, +2.4% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $77 a day (1.6% of price) — the 82nd percentile of the last five years. Moves are running 1.4× normal; trim position sizes accordingly.
- Price structure: Gold $4,689: next resistance $5,306 (+13.2%, tested 2x); nearest support $3,967 (-15.4%, tested 2x). It has spent 23% of the past year between $3,962 and $4,155 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -0.99 — 10Y real yield 2.38%, +0.22pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.42 — Broad dollar 1.3% below its 200DMA, -1.1% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): +1.93 — Price above the 50DMA, above the 200DMA (death cross in force), +16.2% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -0.99 — 2Y yield 4.24%, +0.11pp over 3m; 2Y 0.61pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): -0.48 — 10Y breakevens 2.32% (-0.08pp 3m), 5y5y 2.33% (+0.06pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — +4.0% vs 200DMA, RSI(14) 85 — stretched — chasing here is paying up for someone else's exit.
- **H. Fear & credit** (weight 6.0): +0.50 — VIX 16, BAA-10Y spread 1.63% (+0.06pp 3m) — fear is bidding for havens.
...
- gold_usd: 2026-08-26 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-26 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-26 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-26 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-24 (2d old) via fred-csv
- dgs10: 2026-08-24 (2d old) via fred-csv
- dgs2: 2026-08-24 (2d old) via fred-csv
- t10yie: 2026-08-25 (1d old) via fred-csv
- t5yifr: 2026-08-25 (1d old) via fred-csv
- dollar: 2026-08-21 (5d old) via fred-csv
- vix: 2026-08-24 (2d old) via fred-csv
- baa10y: 2026-08-24 (2d old) via fred-csv
- effr: 2026-08-24 (2d old) via fred-csv
- icsa: 2026-08-15 (11d old) via fred-csv
- unrate: 2026-07-01 (56d old) via fred-csv
- payems: 2026-07-01 (56d old) via fred-csv
- cot: 2026-08-18 (8d old) via cftc-socrata
- gpr: 2026-07-01 (56d old) via iacoviello-xls
- central_banks: 2026-07-30 (27d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (27d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
