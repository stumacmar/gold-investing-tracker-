# Gold Signal Engine — 40.8/100 TRIM

As of 2026-09-11 (generated 2026-09-11T21:00:55.850932Z).

- Gold: $4,389.40 USD / £3,244.47 GBP
...
- GBP lens: XAUGBP £3,244, -4.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,389: next resistance $5,306 (+20.9%, tested 2x); nearest support $3,967 (-9.6%, tested 2x). It has spent 22% of the past year between $3,977 and $4,146 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.26 — 10Y real yield 2.55%, +0.34pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.62 — Broad dollar 1.2% below its 200DMA, -1.7% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -0.39 — Price above the 50DMA, below the 200DMA (death cross in force), +0.6% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.54 — 2Y yield 4.56%, +0.43pp over 3m; 2Y 0.93pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -3.0% vs 200DMA, RSI(14) 33 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 18, BAA-10Y spread 1.55% (+0.02pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.51 — USDJPY 153.6, -3.1% vs 200DMA; no intervention footprint — yen strong versus trend — no FX stress channel supporting gold.
