# Gold Signal Engine — 21.7/100 SELL/REDUCE

As of 2026-09-25 (generated 2026-09-25T07:16:44.049659Z).

- Gold: $4,311.80 USD / £3,261.19 GBP
...
- GBP lens: XAUGBP £3,261, -2.8% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $96 a day (2.2% of price) — the 83rd percentile of the last five years. Moves are running 1.5× normal; trim position sizes accordingly.
- Price structure: Gold $4,312: next resistance $5,315 (+23.3%, tested 2x); nearest support $3,976 (-7.8%, tested 2x). It has spent 21% of the past year between $3,987 and $4,142 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.68 — 10Y real yield 2.76%, +0.53pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +0.28 — Broad dollar 0.1% above its 200DMA, -0.7% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -2.00 — Price below the 50DMA, below the 200DMA (death cross in force), -7.6% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -2.00 — 2Y yield 4.85%, +0.74pp over 3m; 2Y 0.97pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **D. Inflation expectations** (weight 8.0): +0.72 — 10Y breakevens 2.33% (+0.12pp 3m), 5y5y 2.33% (+0.14pp) — inflation expectations drifting higher.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -5.4% vs 200DMA, RSI(14) 31 — no stretch either way.
- **H. Fear & credit** (weight 6.0): -0.25 — VIX 14, BAA-10Y spread 1.39% (-0.13pp 3m) — markets are calm; no safe-haven bid.
...
- **N. FX stress (yen)** (weight 4.0): -0.05 — USDJPY 158.0, -0.3% vs 200DMA; no intervention footprint — no FX stress signal.
...
- gold_usd: 2026-09-25 (0d old) via yahoo:GC=F
- gold_gbp: 2026-09-25 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-09-25 (0d old) via yahoo:SI=F
- usdjpy: 2026-09-25 (0d old) via yahoo:JPY=X
- dfii10: 2026-09-23 (2d old) via fred-csv
- dgs10: 2026-09-23 (2d old) via fred-csv
- dgs2: 2026-09-23 (2d old) via fred-csv
- t10yie: 2026-09-24 (1d old) via fred-csv
- t5yifr: 2026-09-24 (1d old) via fred-csv
- dollar: 2026-09-18 (7d old) via fred-csv
- vix: 2026-09-22 (3d old) via fred-csv
- baa10y: 2026-09-23 (2d old) via fred-csv
- effr: 2026-09-23 (2d old) via fred-csv
- icsa: 2026-09-19 (6d old) via fred-csv
- unrate: 2026-08-01 (55d old) via fred-csv
- payems: 2026-08-01 (55d old) via fred-csv
- cot: 2026-09-15 (10d old) via cftc-socrata
- gpr: 2026-08-01 (55d old) via iacoviello-xls
- central_banks: 2026-07-30 (57d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (57d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
