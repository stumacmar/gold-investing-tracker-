# Gold Signal Engine — 29.8/100 TRIM

As of 2026-08-13 (generated 2026-08-13T07:31:33.758419Z).

- Gold: $4,432.80 USD / £3,287.36 GBP
...
- GBP lens: XAUGBP £3,287, -6.2% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,433: next resistance $5,306 (+19.7%, tested 2x); nearest support $3,967 (-10.5%, tested 2x). It has spent 24% of the past year between $3,945 and $4,145 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.57 — 10Y real yield 2.43%, +0.48pp over 3m — rising real yields are gold’s biggest headwind.
- **E. Trend & momentum** (weight 12.0): +0.43 — Price above the 50DMA, below the 200DMA (death cross in force), +11.2% over 20 sessions — the trend is doing the heavy lifting.
- **C. Policy trajectory** (weight 10.0): -1.25 — 2Y yield 4.22%, +0.27pp over 3m; 2Y 0.59pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
- **B. Dollar** (weight 9.0): -0.07 — Broad dollar 0.6% below its 200DMA, +0.9% over 3m — a firm dollar caps gold.
- **D. Inflation expectations** (weight 8.0): -1.26 — 10Y breakevens 2.26% (-0.21pp 3m), 5y5y 2.28% (+0.03pp) — inflation expectations contained.
...
- **G. Valuation stretch** (weight 8.0): -0.75 — -1.2% vs 200DMA, RSI(14) 81 — stretched — chasing here is paying up for someone else's exit.
- **H. Fear & credit** (weight 7.8): +0.00 — VIX 15, BAA-10Y spread 1.62% (-0.03pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.77 — USDJPY 159.4, +0.8% vs 200DMA; intervention-scale snap -1.9% 10 sessions ago — a 1.9% single-session yen surge off a weak base 10 sessions ago is the footprint of official intervention — Treasury sales and dollar liquidity strain bid gold.
...
- gold_usd: 2026-08-13 (0d old) via yahoo:GC=F
- gold_gbp: 2026-08-13 (0d old) via derived:GC=F/GBPUSD
- silver: 2026-08-13 (0d old) via yahoo:SI=F
- usdjpy: 2026-08-13 (0d old) via yahoo:JPY=X
- dfii10: 2026-08-11 (2d old) via fred-csv
- dgs10: 2026-08-11 (2d old) via fred-csv
- dgs2: 2026-08-11 (2d old) via fred-csv
- t10yie: 2026-08-12 (1d old) via fred-csv
- t5yifr: 2026-08-12 (1d old) via fred-csv
- dollar: 2026-08-07 (6d old) via fred-csv
- vix: 2026-08-11 (2d old) via fred-csv
- baa10y: 2026-08-10 (3d old) via fred-csv
- effr: 2026-08-11 (2d old) via fred-csv
- icsa: 2026-08-01 (12d old) via fred-csv
- unrate: 2026-07-01 (43d old) via fred-csv
- payems: 2026-07-01 (43d old) via fred-csv
- cot: 2026-08-04 (9d old) via cftc-socrata
- gpr: 2026-07-01 (43d old) via iacoviello-xls
- central_banks: 2026-07-30 (14d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
- etf_flows: 2026-07-30 (14d old) via manual (PLACEHOLDER — not scored) [EXCLUDED]
