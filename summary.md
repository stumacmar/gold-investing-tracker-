# Gold Signal Engine — 54.3/100 HOLD

As of 2026-08-28 (generated 2026-08-28T04:58:32.012909Z).

- Gold: $4,633.20 USD / £3,409.62 GBP
...
- GBP lens: XAUGBP £3,410, -1.7% over 3m, mixed vs 200DMA — sterling picture is mixed; let the USD signal lead but scale sizes down.
- Volatility (true ATR(14) from Yahoo GC=F OHLC): Gold is moving about $68 a day (1.5% of price) — the 78th percentile of the last five years. Moves are running 1.3× normal; trim position sizes accordingly.
- Price structure: Gold $4,633: next resistance $5,306 (+14.5%, tested 2x); nearest support $3,967 (-14.4%, tested 2x). It has spent 23% of the past year between $3,967 and $4,155 — price is above it.
...
- **E. Trend & momentum** (weight 12.0): +1.87 — Price above the 50DMA, above the 200DMA (death cross in force), +14.4% over 20 sessions — the trend is doing the heavy lifting.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — +2.6% vs 200DMA, RSI(14) 75 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 15, BAA-10Y spread 1.61% (+0.04pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): +0.12 — USDJPY 159.5, +0.7% vs 200DMA; no intervention footprint — no FX stress signal.
...
- vix: 2026-08-26 (2d old) via fred-csv
- baa10y: 2026-08-26 (2d old) via fred-csv
- effr: 2026-08-26 (2d old) via fred-csv
