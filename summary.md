# Gold Signal Engine — 36.6/100 TRIM

As of 2026-09-21 (generated 2026-09-21T07:20:46.391121Z).

- Gold: $4,388.90 USD / £3,281.36 GBP
...
- GBP lens: XAUGBP £3,281, -2.0% over 3m, downtrend vs 200DMA — sterling gold is trending down: if the USD verdict says add, the currency is eating the move — size down; if it says trim, GBP agrees.
...
- Price structure: Gold $4,389: next resistance $5,315 (+21.1%, tested 2x); nearest support $3,976 (-9.4%, tested 2x). It has spent 21% of the past year between $3,989 and $4,150 — price is above it.

## Signals (score -2 bearish to +2 bullish for gold)

- **A. Real yields** (weight 20.0): -1.34 — 10Y real yield 2.61%, +0.38pp over 3m — rising real yields are gold’s biggest headwind.
- **B. Dollar** (weight 15.0): +1.46 — Broad dollar 1.0% below its 200DMA, -1.6% over 3m — a soft dollar clears the runway.
- **E. Trend & momentum** (weight 12.0): -1.09 — Price above the 50DMA, below the 200DMA (death cross in force), -6.2% over 20 sessions — the tape is against you.
- **C. Policy trajectory** (weight 10.0): -1.61 — 2Y yield 4.67%, +0.47pp over 3m; 2Y 0.79pp above the funds rate (no cuts priced) — rate expectations are firming against gold.
...
- **G. Valuation stretch** (weight 8.0): +0.00 — -3.6% vs 200DMA, RSI(14) 42 — no stretch either way.
- **H. Fear & credit** (weight 6.0): +0.00 — VIX 15, BAA-10Y spread 1.44% (-0.06pp 3m) — no stress signal either way.
...
- **N. FX stress (yen)** (weight 4.0): -0.12 — USDJPY 157.2, -0.7% vs 200DMA; no intervention footprint — no FX stress signal.
...
- dfii10: 2026-09-17 (4d old) via fred-csv
- dgs10: 2026-09-17 (4d old) via fred-csv
- dgs2: 2026-09-17 (4d old) via fred-csv
- t10yie: 2026-09-18 (3d old) via fred-csv
- t5yifr: 2026-09-18 (3d old) via fred-csv
- dollar: 2026-09-11 (10d old) via fred-csv
- vix: 2026-09-17 (4d old) via fred-csv
- baa10y: 2026-09-17 (4d old) via fred-csv
- effr: 2026-09-17 (4d old) via fred-csv
